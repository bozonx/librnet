...
export class RootFilesDriverInstance
  extends DriverInstanceBase<RootFilesDriverInstanceProps, RootFilesDriver>
  implements FilesDriverType
{
  ...
  async readTextFile(
    ...
    return this.io.readTextFile(this.makePath(pathTo), options);
  }
