...
import {DRIVER_NAMES, EXTERNAL_ROOT_DIR, HOME_SUB_DIRS, ROOT_DIRS} from '../../types/constants.js'
...
export class AppContext {
  ...
  constructor(system: System, appName: string) {
    ...
    this.appUserData = new FilesWrapper(filesDriver, pathJoin('/', ROOT_DIRS.home, HOME_SUB_DIRS._Apps, appName))
    this.homeDownloads = new FilesWrapper(filesDriver, pathJoin('/', ROOT_DIRS.home, HOME_SUB_DIRS._Downloads))
