module.exports = {
  ...
  // Настройки для JSDoc
  jsdocSpaces: 1,                     // Количество пробелов в JSDoc
  jsdocDescriptionWithDot: false,     // Не добавлять точку в конец описания JSDoc
  jsdocDescriptionTag: false          // Не добавлять @description тег
}
